...
function useWindowSize() {
  //Get and set current windows size
  ...
  useEffect(() => {
    ...
    //Add eventlistener on resize, when emitted: handleResize
    window.addEventListener('resize', handleResize);
    return () => window.removeEventListener('resize', handleResize); //Remove listener on demount
  }, []);
...
function NewUserInformation() {
  ...
  // Adjusted to neatly fit in a 1920x1080 screen. If smaller, a scrollbar is added
